...
if (isset($_POST['submit']) && $_POST['submit'] == 'sub')
 {
    ...
    if($total_records==0)
    {
        header("location:admin_login.php?msg=Sorry! Username or password is invalid Please try again");
        exit;
    }
    if($total_records>0)
    {
...
<div class="container">
    ...
    <input type="text" class="form-control admin_username" id="username" name="u_name" placeholder="Enter username" required>
    
    <label for="password"  class="admin_label">Password</label>
    <input type="password" class="form-control admin_password" id="username" name="password" placeholder="Enter username" required>
